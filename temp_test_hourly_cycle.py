...
async def main() -> None:
    ...
    For testing the hourly multi-cadence logic, the live cycle call is wrapped
    in freezegun.freeze_time to simulate the top of the hour.
    """
    ...
    log = logging.getLogger("uw.temp_test_hourly_cycle")
    log.info("Manual single-cycle trigger (hourly freeze) starting up…")
    ...
    # --- Single cycle execution with frozen time at top of hour ---
    try:
        with freeze_time("2025-09-11 14:00:00"):
