...
class KucoinClient(BaseExchange):
    """Kucoin exchange client using ccxt in async mode (pro)."""
    ...
    def __init__(self, settings: Any) -> None:
        ...
        # Some ccxt exchanges also require password/passphrase; include if present
        password = getattr(settings, "password", None) or getattr(
    ...
    async def set_leverage(self, symbol: str, leverage: int) -> None:
        ...
        await self._resilient_call(_call)
